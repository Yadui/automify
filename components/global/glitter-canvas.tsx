...
export function CanvasRevealEffectDemo2() {
  return (
    <div className="relative z-20 h-full w-full flex flex-col items-center justify-center text-center">
      <div className="group/canvas-card relative flex items-center justify-center max-w-screen w-full p-4 h-[20rem]">
